...
parser.add_argument("--supervision_rate", type=float, default=0.1, help="Rate of labeled data to pure cir data.")
...
lambda_range = 1
lambda_env = 1
# mask = 0 if np.random.randn(1) > opt.supervision_rate else 1  # should in process
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    for i, batch in enumerate(dataloader):
        ...
        loss_res = lambda_res * criterion_recon(err_gt, err_fake)
        ...
        # Total loss
        loss = loss_ae + loss_range + loss_res + loss_env
